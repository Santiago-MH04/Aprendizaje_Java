...
public class EjemploListComparableComparator {
    public static void main(String[] args) {
        ...
        //Collections.sort(SA, (a, b) -> a.getNota().compareTo(b.getNota())); //A través de la clase helpers
        //SA.sort((a, b) -> a.getNota().compareTo(b.getNota())); //A través del método sort de las listas
        //SA.sort(Comparator.comparing((Alumno a) -> a.getNota()).reversed()); //Usando la interfaz Comparator y una expresión lambda
        SA.sort(Comparator.comparing(Alumno::getNota).reversed()); //Usando la interfaz Comparator y una expresión lambda simplificada
