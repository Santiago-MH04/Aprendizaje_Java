...
@TransaccionalJDBC
@Interceptor
public class TransaccionalInterceptor {
    ...
    //Asignadores de atributos de TransaccionalInterceptor (setters)
    //Lectores de atributos de TransaccionalInterceptor (getters)
    ...
    public Object Transaccional(InvocationContext invocationContext) throws Exception {  //Representa la invocación del método,
        ...
        try {
            ...
            this.Conn.rollback();
            throw e;    //Se relanza la excepción, que atrapa el filtro
        }
    }
}
