...
public class LoggingInterceptor implements Serializable{    //Ni implementando Serializable se arregla el error
    ...
    //Asignadores de atributos de LoggingInterceptor (setter)
    //Lectores de atributos de LoggingInterceptor (getter)
